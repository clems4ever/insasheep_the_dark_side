...
enum attr_type {TYPE_UNKNOWN, TYPE_LOAD, TYPE_STORE, TYPE_ARITH, TYPE_COMPARE, TYPE_SHIFT, TYPE_MULTIPLY, TYPE_DIVIDE, TYPE_CALL, TYPE_ICALL, TYPE_UBRANCH, TYPE_UIBRANCH, TYPE_CBRANCH};
