...
const struct cl_option cl_options[] =
{
  ...
  { "-mbarrel-shift-enabled",
    ...
    N_OPTS, 21, 749,
    CL_TARGET | CL_REPORT,
    &target_flags, CLVC_BIT_SET, MASK_BARREL_SHIFT_ENABLED },
  { "-mdivide-enabled",
    "Enable divide and modulus instructions",
    N_OPTS, 15, 750,
    CL_TARGET | CL_REPORT,
    &target_flags, CLVC_BIT_SET, MASK_DIVIDE_ENABLED },
  { "-mmultiply-enabled",
    "Enable multiply instructions",
    N_OPTS, 17, 751,
    CL_TARGET | CL_REPORT,
    &target_flags, CLVC_BIT_SET, MASK_MULTIPLY_ENABLED },
  { "-msign-extend-enabled",
    "Enable sign extend instructions",
    N_OPTS, 20, 752,
    CL_TARGET | CL_REPORT,
    &target_flags, CLVC_BIT_SET, MASK_SIGN_EXTEND_ENABLED },
  { "-muser-enabled",
    "Enable user-defined instructions",
    N_OPTS, 13, 753,
    CL_TARGET | CL_REPORT,
    &target_flags, CLVC_BIT_SET, MASK_USER_ENABLED },
  { "-nocpp",
